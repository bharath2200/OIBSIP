...
A personal portfolio website developed using React + Vite showcasing my skills, projects, and contact information.
...
OIBSIP/
│
├── Bharath_Task1_LandingPage
├── Bharath_Task2_Portfolio
├── Bharath_Task3_TemperatureConverter
├── Bharath_Task4_TodoList
└── Bharath_Task5_Calculator
```
